...
<body style="background-color:#167fa6">
    <div class="bg-secondary p-2 mb-4">
        <h3 class="text-left text-white">Sistem Penilaian</h3>
    </div>
    <div class="container">    
        <form class="form-horizontal p-5 shadow" style="background-color:#32e3cb" method="GET" action="form_nilai.php">
    ...
    ?>
    <div class="container mt-5 mb-5 p-5 shadow" style="background-color:#32e3cb;">
        <div class="row p-1 ">
    ...
    <div class="container shadow p-5 mt-5" style="background-color:#9ef0de;">
